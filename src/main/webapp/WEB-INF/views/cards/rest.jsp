...
<script src="${pageContext.request.contextPath }/resources/JS/cards/cards.js"></script>
...
<div id="main">
	...
	<input type="hidden" id="usuid" name="usuid" value="${ login.us_uid}"> 
	<%-- 헤더 --%>
	<div class="h01">
		<div class="left" id="pageinfo"></div>
		<div class="selected">
			<select class="form-control selectpicker" id="location" name="location">
			...
			<select class="form-control selectpicker" id="withs" name="withs">
			...
			<select class="form-control selectpicker" id="focus" name="focus">
...
<div id="dlg_write" class="modal" style="overflow: auto;">
	<form class="modal-content animate"  id="frmWrite" name="frmWrite" method="post" multiple="true"  enctype="multipart/form-data">
		<div class="container">
			...
			<div class="slide-count" style="text-align:center"></div>
			<div class="clear"></div>
			<br>
