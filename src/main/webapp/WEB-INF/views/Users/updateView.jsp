...
<body>
	<section id="container">
		<form action="updateView" method="post">
			...
			<div class="form-group has-feedback">
				<label class="control-label" for="userEmail">메일</label> <input
			...
			<div class="form-group has-feedback">
				<label class="control-label" for="userMemo">메모</label> <input
					...
					value="${login.userMemo}" />
			</div>
			<div class="form-group has-feedback">
				<button class="btn btn-success" type="submit" id="submit"  submit = "${path}/Users/profile">회원정보수정</button>
