...
<body>
	...
	<!--  
		<form action="updateView/updateImage" method="post">
			<div class="form-group">
				<img id="userPic" onerror="this.src='C:/DevRoot/Dropbox/SpringProject/today_trip/src/main/webapp/resources/IMG/Profile/unnamed.jpg' src="${login.userPic}" />
			</div>
			<div class="form-group">
				<input type="file" name="userPic" id="usrPic"/>
			</div>
			<div class="form-group">
		...
		<form action="/updateView" method="post">
			...
			<div class="form-group has-feedback">
				<label class="control-label" for="userNickname">성명</label> <input
					class="form-control" type="text" id="userNickname"
					name="userNickname" value="${login.userNickname}" />
			</div>
			<div class="form-group has-feedback">
				<label class="control-label" for="userEmail">이메일</label> <input
					class="form-control" type="text" id="userEmail"
					name="userEmail" value="${login.userEmail}" />
			</div>
			
			<div class="form-group has-feedback">
				<button class="btn btn-success" type="submit" id="submit" submit="/today_trip/home">회원정보수정</button>
